...
keytool -v -importcert -file client_1.cer -alias server -keystore client_1.jks -storepass secret
...
openssl pkcs12 -in client_1.p12 -nokeys -out client_1.crt -password pass:secret
openssl pkcs12 -in client_1.p12 -nocerts -nodes -out client_1.key -password pass:secret
